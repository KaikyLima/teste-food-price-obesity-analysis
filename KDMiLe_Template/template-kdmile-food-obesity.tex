...
geographic area. We conduct an exploratory and correlational analysis to investigate
whether variations in healthy food prices and income level are statistically associated
with obesity rates across geographic regions. Subsequently, a regression model is applied
to quantify the magnitude of this impact. Additionally, income level is examined as a
...
disproportionately affected. This work is aligned with the topics of Data Mining
Applications, Machine Learning Applications, Time-Series Analysis, and Supervised
Learning.
\end{abstract}
